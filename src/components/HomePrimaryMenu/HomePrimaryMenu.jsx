...
export const HomePrimaryMenu = ({ property1, className }) => {
  return (
      ...
      <div className="frame-10">
        <div className="frame-11">
          <div className="frame-12">
            <img className="ellipse-2" alt="Ellipse" src="https://c.animaapp.com/zzQb4IEW/img/ellipse-1-3@2x.png" />
            <div className="text-wrapper-8">John Smith</div>
          </div>
          <FluentIosArrow24Filled2 className="fluent-ios-arrow" color="white" />
        </div>
      </div>
    </div>
  );
